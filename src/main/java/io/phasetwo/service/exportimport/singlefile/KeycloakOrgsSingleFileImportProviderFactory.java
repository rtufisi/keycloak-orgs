...
public class KeycloakOrgsSingleFileImportProviderFactory implements ImportProviderFactory {
    ...
    public ImportProvider create(KeycloakSession session) {
        ...
        return new KeycloakOrgsSingleFileImportProvider(session.getKeycloakSessionFactory(), new File(fileName), strategy);
    }
