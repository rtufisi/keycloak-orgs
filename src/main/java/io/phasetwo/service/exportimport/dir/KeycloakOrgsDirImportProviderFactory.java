...
public class KeycloakOrgsDirImportProviderFactory implements ImportProviderFactory {
    ...
    public ImportProvider create(KeycloakSession session) {
        ...
        return new KeycloakOrgsDirImportProvider(session.getKeycloakSessionFactory(), strategy)
                .withDir(dir)
